...
public:
    ...
    IBLT(size_t _expectedNumEntries, size_t valueSize, float hedge, size_t _numHashes);
    IBLT(size_t _expectedNumEntries, size_t valueSize);
    IBLT(size_t valueSize, size_t ibltSize, size_t numHashes);
    IBLT(size_t valueSize, size_t nEntries, size_t numHashes, IBLT::Normal);
    ...
    static size_t entrybytesize(size_t _valueSize);

    size_t bytesize() const;

    int hashTableSize() const;

    void static set_parameter_file(const char * filename);
